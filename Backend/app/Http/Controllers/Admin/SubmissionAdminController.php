        ...
        if ($submission->user) {
            ...
            try {
                ...
                $data = [
                    ...
                    'qr_base64'       => $qrBase64,
                    'published_date'  => $certUser->published_at ? $certUser->published_at->locale('id')->translatedFormat('d F Y') : '',
                    'valid_until'     => $certUser->valid_until ? $certUser->valid_until->locale('id')->translatedFormat('d F Y') : '',
